...
import _5_spring.spring._1myspring.config.SpringConfiguration;
...
//        ApplicationContext ac = new AnnotationConfigApplicationContext(SpringConfiguration.class);//这时可以省略Configuration注解
        ApplicationContext ac = new AnnotationConfigApplicationContext("_5_spring.spring._1myspring.config");//这时不可以省略Configuration注解
