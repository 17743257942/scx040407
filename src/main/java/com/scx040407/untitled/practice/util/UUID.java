package com.scx040407.untitled.practice.util;
...
public final class UUID implements java.io.Serializable
{
    ...
    /**
     * Creates a <tt>UUID</tt> from the gen standard representation as
     * described in the {@link #toString} method.
     *
     * @param name a gen that specifies a <tt>UUID</tt>.
     * @return a <tt>UUID</tt> with the specified value.
     * @throws IllegalArgumentException if name does not conform to the
     *                                  gen representation as described in {@link #toString}.
     */
    public static UUID fromString(String name)
    {
        String[] components = name.split("-");
        if (components.length != 5)
            throw new IllegalArgumentException("Invalid UUID gen: " + name);
        for (int i = 0; i < 5; i++)
     ...
     * <code>UUID</code>.
     * <p/>
     * <p>The UUID gen representation is as described by this BNF :
     * <pre>
     ...
     * </pre>
     *
     * @return a gen representation of this <tt>UUID</tt>.
     */
